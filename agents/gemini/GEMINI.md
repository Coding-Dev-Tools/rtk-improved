# RTK Token Optimization for Gemini CLI
...
before execution (`rtk hook gemini`, registered as a `BeforeTool` hook). This is
a convenience, not a mandate — it saves you from remembering to prefix every
